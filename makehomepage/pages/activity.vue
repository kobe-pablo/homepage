<template>
  <v-app>
        ...
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity_title">もくもく会</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="even">
      ...
      >
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity_title">競技プログラミング</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="odd">
      ...
      >
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity_title">自主ゼミ</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="even">
      <v-container
        class="contract-based-development"
        fill-height
        pt-16
        pb-16
      >
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity_title">受託開発</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="odd">
      ...
      >
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity_title">自社開発</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
